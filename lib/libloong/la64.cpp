...
namespace loongarch
{
	...
	#define LASX_INSTRUCTION_P(name, printer) \
		static constexpr CPU::instruction_t instr64_##name { LasxImpl::name, LasxPrinters::printer, InstrId::name }
#else
	// When LASX is disabled, map to UNIMPLEMENTED
	#define LASX_INSTRUCTION(name) \
	...
	LASX_INSTRUCTION(XVLD);
	LASX_INSTRUCTION(XVST);

	// LASX (256-bit) Instructions
	LASX_INSTRUCTION(XVREPLGR2VR_B);
	LASX_INSTRUCTION(XVXOR_V);
	LASX_INSTRUCTION(XVADD_D);
	LASX_INSTRUCTION(XVSUB_W);
	LASX_INSTRUCTION(XVPICKVE2GR_W);
	LASX_INSTRUCTION(XVHADDW_D_W);
	LASX_INSTRUCTION(XVHADDW_Q_D);
	LASX_INSTRUCTION(XVBITSEL_V);
	LASX_INSTRUCTION(XVFCMP_COND_D);
	LASX_INSTRUCTION(XVMIN_BU);
	LASX_INSTRUCTION(XVMAX_BU);
	LASX_INSTRUCTION(XVMSKNZ_B);
	LASX_INSTRUCTION(XVPICKVE_W);
	LASX_INSTRUCTION(XVSETANYEQZ_B);
	LASX_INSTRUCTION(XVSEQ_B);
	LASX_INSTRUCTION(XVSETEQZ_V);
	LASX_INSTRUCTION(XVPERMI_Q);
	LASX_INSTRUCTION(XVLDX);
	LASX_INSTRUCTION(XVSTX);
	LASX_INSTRUCTION(XVFADD_D);
	LASX_INSTRUCTION(XVFMUL_D);
	LASX_INSTRUCTION(XVFDIV_D);
	LASX_INSTRUCTION(XVFSUB_D);
	LASX_INSTRUCTION(XVBITREVI_D);
	LASX_INSTRUCTION(XVREPLVE_D);
	LASX_INSTRUCTION(XVFMADD_S);
	LASX_INSTRUCTION(XVFMADD_D);
	LASX_INSTRUCTION(XVFMSUB_S);
	LASX_INSTRUCTION(XVFMSUB_D);
	LASX_INSTRUCTION(XVFNMADD_S);
	LASX_INSTRUCTION(XVFNMADD_D);
	LASX_INSTRUCTION(XVFNMSUB_S);
	LASX_INSTRUCTION(XVFNMSUB_D);
	LASX_INSTRUCTION(XVORI_B);
	LASX_INSTRUCTION(XVXORI_B);
	LASX_INSTRUCTION(XVILVL_D);
	LASX_INSTRUCTION(XVILVH_D);
	LASX_INSTRUCTION(XVPERMI_D);
	LASX_INSTRUCTION(XVPACKEV_D);
	LASX_INSTRUCTION(XVPACKOD_D);
	LASX_INSTRUCTION(XVPICKEV_D);
	LASX_INSTRUCTION(XVPICKEV_W);
	LASX_INSTRUCTION(XVPICKOD_D);
	LASX_INSTRUCTION(XVLDI);
